        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="card-title mt-lg-3 d-inline-block">{{ __('Proyectos') }}</div>
                        </div>

                        <div class="col-lg-3">
                            <form action="{{ route('vendor.project_management.projects') }}" method="get"
                                id="carSearchForm">
                                <div class="row">
                        ...
                        <div class="col-lg-3 mt-lg-3">
                            ...
                            <button class="btn btn-danger btn-sm float-lg-right mr-2 d-none bulk-delete"
                                data-href="{{ route('vendor.project_management.bulk_delete_project') }}"><i
                                        ...
                                        <tbody>
                                            @foreach ($projects as $project)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (!is_null($project->agent_id) && $project->agent_id != 0)
                                                            <a
                                                                href="{{ route('frontend.agent.details', ['username' => @$project->agent->username]) }}">{{ @$project->agent->username }}</a>
                                                        @else
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary  mt-1 btn-sm mr-1"
                                                            href="{{ route('vendor.project_management.project_types', $project->id) }}">
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($project->approve_status == 0)
                                                    ...
                                                    <td>
                                                        <form id="statusForm{{ $project->id }}" class="d-inline-block"
                                                            action="{{ route('vendor.project_management.update_status') }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('vendor.project_management.edit', $project->id) }}">
                                                                    <span class="btn-label">
                                                                ...
                                                                <form class="deleteForm d-inline-block dropdown-item"
                                                                    action="{{ route('vendor.project_management.delete_project') }}"
                                                                    method="post">
                                                                    @csrf
