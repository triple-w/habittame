...
@section('content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form id="statusForm-{{ $agent->id }}" class="d-inline-block"
                                                            action="{{ route('admin.agent_management.change_status', ['id' => $agent->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <select
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                ...
                                                                <form class="deleteForm d-block"
                                                                    action="{{ route('admin.agent_management.destroy', ['id' => $agent->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                                ...
                                                                <a target="_blank"
                                                                    href="{{ route('admin.agent_management.secret_login', ['id' => $agent->id]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Secret Login') }}
                                                                </a>
                                                            </div>
    ...
    {{-- create modal --}}
    @include('backend.agent.create')

    {{-- edit modal --}}
    @include('backend.agent.edit')
@endsection
