                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview" id="thumbPreview1">
                                                @if (!empty($data->preloader))
                                                    <img src="{{ asset('assets/img/' . $data->preloader) }}"
                                                        alt="Preloader" class="preloader-uploaded-img">
                                                @else
                                                    <img src="{{ asset('assets/img/noimage.jpg') }}" alt="..."
                                            ...
                                            <p class="text-warning mb-0">
                                                {{ __('JPG, PNG, JPEG, GIF, SVG images are allowed') }}</p>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    @if ($errors->has('secondary_color'))
                                                        <p class="mt-2 mb-0 text-danger">
                                                            {{ $errors->first('secondary_color') }}</p>
                                                    @endif
                                                </div>
                                            </div>
