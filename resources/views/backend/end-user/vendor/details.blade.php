                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h2 class="text-center">
                                @if ($vendor->photo != null)
                                    <img class="admin-vendor-photo"
                                        src="{{ asset('assets/admin/img/vendor-photo/' . $vendor->photo) }}" alt="..."
                                        class="uploaded-img">
                                @else
                                    <img class="admin-vendor-photo" src="{{ asset('assets/img/blank-user.jpg') }}"
                        ...
                        <div class="card-body">
                            <div class="payment-information">
                                ...
                                @php
                                    $currPackage = \App\Http\Helpers\VendorPermissionHelper::currPackageOrPending(
                                        $vendor->id,
                                    );
                                    $currMemb = \App\Http\Helpers\VendorPermissionHelper::currMembOrPending(
                                        $vendor->id,
                                    );
                                @endphp
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        @if ($currPackage)
                                            ...
                                            <span
                                                class="badge badge-secondary badge-xs mr-2">{{ $currPackage->term }}</span>
                                            ...
                                            <form action="{{ route('vendor.currPackage.remove') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        @if ($nextPackage)
                                            ...
                                            <span
                                                class="badge badge-secondary badge-xs mr-2">{{ $nextPackage->term }}</span>
                                            <button type="button" class="btn btn-xs btn-warning" data-toggle="modal"
                                                data-target="#editNextPackage"><i class="far fa-edit"></i></button>
                                            <form action="{{ route('vendor.nextPackage.remove') }}"
                                                class="d-inline-block deleteForm" method="POST">
                                                @csrf
                                                <input type="hidden" name="vendor_id" value="{{ $vendor->id }}">
                                                <button type="submit" class="btn btn-xs btn-danger deleteBtn"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                                    ...
                                    <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                        data-href="{{ route('admin.property_management.bulk_delete_property') }}">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12">
                                @if (count($properties) == 0)
                                    <h3 class="text-center mt-2">{{ __('NO PROPERTIES FOUND') . '!' }}</h3>
                                @else
                                            ...
                                            <tbody>
                                                @foreach ($properties as $property)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form id="statusForm{{ $property->id }}"
