        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="carForm2" class="modal-form"
                    action="{{ $agent->vendor_id != 0 ? route('agent.project_management.project_type.update') : route('agent.admin.project_management.project_type.update') }}"
