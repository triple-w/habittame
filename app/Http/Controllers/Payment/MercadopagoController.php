...
class MercadopagoController extends Controller
{
    ...
    public function successPayment(Request $request)
    {
        ...
        if ($payment['status'] == 'approved') {
            ...
            $file_name = $this->makeInvoice($requestData, "membership", $vendor, $amount, "Mercado Pago", $requestData['phone'], $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
