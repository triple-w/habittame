...
class RazorpayController extends Controller
{
    ...
    public function successPayment(Request $request)
    {
        ...
        if ($success === true) {
            ...
            $file_name = $this->makeInvoice($requestData, "membership", $vendor, $amount, "Razorpay", $vendor->phone, $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
