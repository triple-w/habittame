...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Vendor Section') }}</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card-title">{{ __('Update Vendor Section') }}</div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mx-auto">
                            <form id="categoryForm"
                                action="{{ route('admin.home_page.update_vendor_section', ['language' => request()->input('language')]) }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
