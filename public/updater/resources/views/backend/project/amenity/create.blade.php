    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Add Project Amenity') }}</h5>
            ...
            <div class="modal-body">
                <form id="ajaxForm" class="modal-form create"
                    action="{{ route('admin.project_management.store_amenity') }}" method="post">
                    @csrf 
                    ...
                    @foreach ($langs as $lang)
                        <div class="form-group {{ $lang->direction == 1 ? 'rtl text-right' : '' }}">
                            ...
                            <input type="text" class="form-control" name="{{ $lang->code }}_name"
                                placeholder="Enter aminity name for {{ $lang->name }} language">
