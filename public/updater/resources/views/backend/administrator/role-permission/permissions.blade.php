                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <div class="selectgroup selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                value="Payment Log" @if (is_array($rolePermissions) && in_array('Payment Log', $rolePermissions)) checked @endif>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                ...
                                                @if (is_array($rolePermissions) && in_array('Property Specifications', $rolePermissions)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Property Specifications') }}</span>
                                        </label>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                ...
                                                @if (is_array($rolePermissions) && in_array('Featured Properties', $rolePermissions)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Featured Properties') }}</span>
                                        </label>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                value="Agent" @if (is_array($rolePermissions) && in_array('Agent', $rolePermissions)) checked @endif>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                value="Advertise" @if (is_array($rolePermissions) && in_array('Advertise', $rolePermissions)) checked @endif>
