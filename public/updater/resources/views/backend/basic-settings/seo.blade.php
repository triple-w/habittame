                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_projects" rows="5" placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_description_projects }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('Meta Keywords For Agent Login Page') }}</label>
                                    <input class="form-control" name="meta_keyword_agent_login"
                                        value="{{ is_null($data) ? '' : $data->meta_keyword_agent_login }}"
                                        placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Agent Login Page') }}</label>
                                    <textarea class="form-control" name="meta_description_agent_login" rows="5" placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_description_agent_login }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>{{ __('Meta Keywords For Agent Forget Password Page') }}</label>
                                    <input class="form-control" name="meta_keywords_agent_forget_password"
                                        value="{{ is_null($data) ? '' : $data->meta_keywords_agent_forget_password }}"
                                        placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Agent Forget Password Page') }}</label>
                                    <textarea class="form-control" name="meta_descriptions_agent_forget_password" rows="5"
                                        placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_descriptions_agent_forget_password }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keywords_pricing_page"
                                        value="{{ is_null($data) ? '' : $data->meta_keywords_pricing_page }}"
                                        placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Pricing Page') }}</label>
                                    <textarea class="form-control" name="meta_description_pricing_page" rows="5"
                                        placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_description_pricing_page }}</textarea>
                                </div>
                            </div>
