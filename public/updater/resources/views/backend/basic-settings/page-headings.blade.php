                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Property Page Title') . '*' }}</label>
                                            <input type="text" class="form-control" name="property_page_title"
                                                value="{{ $data != null ? $data->property_page_title : '' }}">
                                            @error('property_page_title')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Project Page Title') . '*' }}</label>
                                            <input type="text" class="form-control" name="project_page_title"
                                                value="{{ $data != null ? $data->project_page_title : '' }}">
                                            @error('project_page_title')
                                                <p class="mt-2 mb-0 text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Agent Page Title') . '*' }}</label>
                                            <input type="text" class="form-control" name="agent_page_title"
                                                value="{{ $data != null ? $data->agent_page_title : '' }}">
                                            @error('agent_page_title')
                                                <p class="mt-2 mb-0 text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Agent Login Page Title') . '*' }}</label>
                                            <input type="text" class="form-control" name="agent_login_page_title"
                                                value="{{ $data != null ? $data->agent_login_page_title : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('Agent Forget Page Title') . '*' }}</label>
                                            <input type="text" class="form-control"
                                                name="agent_forget_password_page_title"
                                                value="{{ $data != null ? $data->agent_forget_password_page_title : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ __('User Wishlist Page Title') . '*' }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="vendor_forget_password_page_title"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                name="support_ticket_create_page_title"
