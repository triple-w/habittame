...
@section('content')
            ...
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('vendor.project_management.bulk_delete_type') }}">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($types) == 0)
                                <h3 class="text-center mt-2">{{ __('NO PROJECT TYPES FOUND') . '!' }}</h3>
                            @else
                                    ...
                                    <table class="table table-striped mt-3" id="basic-datatables">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">
                                                    {{ __('Precio MInimo') . ' (' . $settings->base_currency_text . ')' }}</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form class="deleteForm d-inline-block"
                                                            action="{{ route('vendor.project_management.delete_type') }}"
                                                            method="post">
                                                            @csrf
    ...
    {{-- create modal --}}
    @include('vendors.project.type.create')

    {{-- edit modal --}}
    @include('vendors.project.type.edit')
@endsection
