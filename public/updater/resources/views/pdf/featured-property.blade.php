        ...
        <div class="header">
            <div class="ml-20">
                <table class="text-left">
                    ...
                    <tr>
                        <td class="strong">{{ ucfirst($member['name']) }}
                        </td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>{{ __('Username') . ':' }}
                            </strong>{{ $member['username'] }}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>{{ __('Email') . ':' }} </strong> {{ $member['email'] }}
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="order-details">
                <table class="text-right">
                    ...
                    <tr>
                        <td class="gry-color small"><strong>{{ __('Transaction ID') . ':' }}</strong>
                            #{{ $transaction_id }}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>Total:</strong>
                            ...
                            {{ $amount }}
                            {{ $websiteInfo->base_currency_text_position == 'right' ? $websiteInfo->base_currency_text : '' }}
                        </td>
                    </tr>
                    <tr>
            ...
            <table class="padding text-left small border-bottom">
                <thead>
                    <tr class="gry-color info-titles">
                        <th width="20%">{{ __('Property Title') }}</th>
                ...
                <tbody class="strong">
                    ...
                    <tr class="text-center">
                        ...
                        <td>{{ \Carbon\Carbon::parse($startDate)->format('d-M-Y H:i:s') }}</td>
                        <td>
                            {{ \Carbon\Carbon::parse($endDate)->format('d-M-Y H:i:s') }}
                        </td>
