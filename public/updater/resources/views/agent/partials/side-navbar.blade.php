        ...
        <div class="sidebar-content">
                        ...
                        <ul class="nav">
                            ...
                            <li>
                                <a href="{{ route('agent.change_password') }}">
                                    <span class="link-collapse">{{ __('Cambiar Password') }}</span>
                                </a>
                            </li>
            ...
            @elseif (request()->routeIs('agent.property_management.edit')) active @endif">
                                    <a
                                        ...
                                        <span class="sub-item">{{ __('Editar Propiedad') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="nav nav-collapse">
                                ...
                                <li
                                    ...
                                    <a href="{{ route('agent.project_management.create_project') }}">
                                        <span class="sub-item">{{ __('Agregar Projecto') }}</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a
                                        ...
                                        <span class="sub-item">{{ __('Editar Projecto') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
