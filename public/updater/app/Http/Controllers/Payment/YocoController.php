    ...
    public function successPayment(Request $request)
    {
        ...
        if ($id && $information['secret_key'] == $s_key) {
            ...
            if (in_array($paymentFor, ['membership', 'extend'])) {
                ...
                $file_name = $this->makeInvoice($requestData, 'membership', $vendor, $amount, 'Yoco', $vendor->phone, $bs->base_currency_symbol_position, $bs->base_currency_symbol, $bs->base_currency_text, $transaction_id, $package->title, $lastMemb);
